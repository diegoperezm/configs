...
#+END_EXPORT")
 ...
 '(package-selected-packages
   (quote
    (desktop+ js-comint htmlize  emmet-mode web-mode prettier-js js2-mode flycheck org-bullets exec-path-from-shell key-chord el-get use-package evil-terminal-cursor-changer evil auto-complete)))
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:family "Liberation  Mono" :foundry "outline" :slant normal :weight normal :height 140 :width normal))))
...
(defun prettify-set ()
  (setq prettify-symbols-alist
		`(
		  ...
		  ("==="         . ?≡)
		  ("elem"        . ?∈)
 		  ("elem2"       . ,(prettify-string  "∈2"))
 		  ("elem2"       . ,(prettify-string  "∈3"))
		  ("&&"          . ?^)
		  ("||"          . ?∨)
		  (">="          . ?≥)
		  ("for"         . ?∀)
